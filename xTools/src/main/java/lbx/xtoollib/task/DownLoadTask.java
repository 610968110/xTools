...
import lbx.xtoollib.net.IDownLoad;
...
public class DownLoadTask {
    ...
    public static void singleDownload(final String url, final String filePath, final String fileName, DownloadCallBack callback) {
        if (callback == null) {
