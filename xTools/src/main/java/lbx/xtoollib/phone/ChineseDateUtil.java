...
/**
 * Created by 61096 on 2016/8/1.
 * 获取农历日期管理类
 */
public class ChineseDateUtil {

    private static int gregorianYear;
    private static int gregorianMonth;
    ...
    private static ChineseDateUtil INSTANCE;

    public static ChineseDateUtil getInstance() {
        if (INSTANCE == null) {
            synchronized (ChineseDateUtil.class) {
                if (INSTANCE == null) {
                    INSTANCE = new ChineseDateUtil();
                }
            }
        }
        return INSTANCE;
    ...
    public String getChineseDay(int y, int m, int d) {
        ChineseDateUtil c = new ChineseDateUtil();
    ...
    public void setGregorianYear(int gregorianYear) {
        ChineseDateUtil.gregorianYear = gregorianYear;
    }
    ...
    public void setGregorianMonth(int gregorianMonth) {
        ChineseDateUtil.gregorianMonth = gregorianMonth;
    }
    ...
    public void setGregorianDate(int gregorianDate) {
        ChineseDateUtil.gregorianDate = gregorianDate;
    }
    ...
    public void setGregorianLeap(boolean isGregorianLeap) {
        ChineseDateUtil.isGregorianLeap = isGregorianLeap;
    }
    ...
    public void setDaysInGregorianMonth(char[] daysInGregorianMonth) {
        ChineseDateUtil.daysInGregorianMonth = daysInGregorianMonth;
    }
    ...
    public void setStemNames(String[] stemNames) {
        ChineseDateUtil.stemNames = stemNames;
    }
    ...
    public void setBranchNames(String[] branchNames) {
        ChineseDateUtil.branchNames = branchNames;
    }
    ...
    public static void setAnimalNames(String[] animalNames) {
        ChineseDateUtil.animalNames = animalNames;
    }
    ...
    public void setChineseMonths(char[] chineseMonths) {
        ChineseDateUtil.chineseMonths = chineseMonths;
    }
    ...
    public void setBaseYear(int baseYear) {
        ChineseDateUtil.baseYear = baseYear;
    }
    ...
    public void setBaseMonth(int baseMonth) {
        ChineseDateUtil.baseMonth = baseMonth;
    }
    ...
    public void setBaseDate(int baseDate) {
        ChineseDateUtil.baseDate = baseDate;
    }
    ...
    public void setBaseIndex(int baseIndex) {
        ChineseDateUtil.baseIndex = baseIndex;
    }
    ...
    public void setBaseChineseYear(int baseChineseYear) {
        ChineseDateUtil.baseChineseYear = baseChineseYear;
    }
    ...
    public void setBaseChineseMonth(int baseChineseMonth) {
        ChineseDateUtil.baseChineseMonth = baseChineseMonth;
    }
    ...
    public void setBaseChineseDate(int baseChineseDate) {
        ChineseDateUtil.baseChineseDate = baseChineseDate;
    }
    ...
    public void setBigLeapMonthYears(int[] bigLeapMonthYears) {
        ChineseDateUtil.bigLeapMonthYears = bigLeapMonthYears;
    }
    ...
    public void setSectionalTermMap(char[][] sectionalTermMap) {
        ChineseDateUtil.sectionalTermMap = sectionalTermMap;
    }
    ...
    public void setSectionalTermYear(char[][] sectionalTermYear) {
        ChineseDateUtil.sectionalTermYear = sectionalTermYear;
    }
    ...
    public void setPrincipleTermMap(char[][] principleTermMap) {
        ChineseDateUtil.principleTermMap = principleTermMap;
    }
    ...
    public void setPrincipleTermYear(char[][] principleTermYear) {
        ChineseDateUtil.principleTermYear = principleTermYear;
    }
    ...
    public void setMonthNames(String[] monthNames) {
        ChineseDateUtil.monthNames = monthNames;
    }
    ...
    public void setChineseMonthNames(String[] chineseMonthNames) {
        ChineseDateUtil.chineseMonthNames = chineseMonthNames;
    }
    ...
    public void setPrincipleTermNames(String[] principleTermNames) {
        ChineseDateUtil.principleTermNames = principleTermNames;
    }
    ...
    public void setSectionalTermNames(String[] sectionalTermNames) {
        ChineseDateUtil.sectionalTermNames = sectionalTermNames;
    }
}
